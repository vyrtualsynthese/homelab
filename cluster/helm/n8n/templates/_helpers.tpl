...
*/}}
{{- define "n8n.name" -}}
{{- default .Chart.Name .Values.n8n.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
*/}}
{{- define "n8n.fullname" -}}
{{- if .Values.n8n.fullnameOverride }}
{{- .Values.n8n.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.n8n.nameOverride }}
